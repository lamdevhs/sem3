...
from List import zipWith, filterOutIx, firstIndex, grouped, mapLL
...
# the arrow.
#
# the symbol `[!]` at the end of a type signature represents the
# possibility that the functions raise an exception.
